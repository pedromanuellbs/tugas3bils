          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <div class="input-group input-group-merge">
                ...
                <input type="text" name="nama" class="form-control" id="basic-icon-default-fullname" placeholder="John Doe" aria-label="John Doe" aria-describedby="basic-icon-default-fullname2" value="{{ $data->nama }}" />
              </div>
            </div>
          </div>
          {{-- <div class="row mb-3">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <div class="input-group input-group-merge">
                ...
                <input type="text" name="notelpon" id="basic-icon-default-phone" class="form-control phone-mask" placeholder="658 799 8941" aria-label="658 799 8941" aria-describedby="basic-icon-default-phone2" value="{{ $data->notelpon }}" />
              </div>
            </div>
          </div>
          <div class="row mb-3">
